        ...
        <section className="text-gray-700 body-font">
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
                <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                    ...
                    <img alt="feature" className="object-cover object-center h-full w-full" src="https://static.dribbble.com/users/2559/screenshots/7160939/media/694f3d152be6ed6f3bf4cf08c794101a.jpg" />
                </div>
